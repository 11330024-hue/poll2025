...
from .views import poll_list, Pollist, PollView, PollVote, PollEdit, PollCreate, OptionCreate, OptionEdit, PollDelete, OptionDelete

urlpatterns = [
    path("", poll_list),
    path("list", Pollist.as_view(), name='poll_list'),
    ...
    path("<int:pk>/delate", PollDelete.as_view(), name='poll_delete'),
